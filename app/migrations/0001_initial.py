    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ngay_them', models.DateTimeField()),
                ('ngay_cap_nhat', models.DateTimeField()),
                ('loai_san_pham', models.CharField(blank=True, max_length=255, null=True)),
            ],
            options={
                'db_table': 'san_pham',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id_nguoi_dung', models.OneToOneField(db_column='ID_nguoi_dung', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='app.nguoidung')),
